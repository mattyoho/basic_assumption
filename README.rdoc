...
the behavior given to +assume+ is correct for most cases save one or two. It is
possible to override to override the value of the resource method in particular
actions to accommodate the exceptional cases more easily. For example:
