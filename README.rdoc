...
To run the Cucumber suite for the first time, use this Rake task:

    rake init

This will create an example Rails app in ./tmp and run the cukes against it.
Use +rake+ +spec+ to run BasicAssumption's specs, or +rake+ to run specs and
cukes.
